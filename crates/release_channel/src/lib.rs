...
pub fn app_identifier() -> &'static str {
    match *RELEASE_CHANNEL {
        ReleaseChannel::Dev => "nano-zed-Editor-Dev",
        ReleaseChannel::Nightly => "nano-zed-Editor-Nightly",
        ReleaseChannel::Preview => "nano-zed-Editor-Preview",
        ReleaseChannel::Stable => "nano-zed-Editor-Stable",
    }
}
...
impl ReleaseChannel {
    ...
    pub fn display_name(&self) -> &'static str {
        match self {
            ReleaseChannel::Dev => "nano-zed Dev",
            ReleaseChannel::Nightly => "nano-zed Nightly",
            ReleaseChannel::Preview => "nano-zed Preview",
            ReleaseChannel::Stable => "nano-zed",
        }
    }
    ...
    pub fn app_id(&self) -> &'static str {
        match self {
            ReleaseChannel::Dev => "dev.nanogpt.NanoZed-Dev",
            ReleaseChannel::Nightly => "dev.nanogpt.NanoZed-Nightly",
            ReleaseChannel::Preview => "dev.nanogpt.NanoZed-Preview",
            ReleaseChannel::Stable => "dev.nanogpt.NanoZed",
        }
    }
