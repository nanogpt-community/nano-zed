...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "nano-zed Editor Dev Instance Running",
        ReleaseChannel::Nightly => "nano-zed Editor Nightly Instance Running",
        ReleaseChannel::Preview => "nano-zed Editor Preview Instance Running",
        ReleaseChannel::Stable => "nano-zed Editor Stable Instance Running",
    }
}
